...
//		    .entity(userPrincipal).build();
//	} else {
//	    return Response.status(Response.Status.UNAUTHORIZED).build();
//	}
//    }

    public Response authorize2() {

	Cookie uiColorCookie = new Cookie("color", "red");
	var res = Response.status(Response.Status.ACCEPTED)
		    .build();
//	res.getCookies().put(arg0, arg1)addCookie(uiColorCookie);
	return res;
    }
